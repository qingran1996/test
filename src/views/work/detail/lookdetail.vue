<template>
	<div class="worklookdetail">
		<van-form ref="addform">
			...
			<van-cell center :value="addForm.a" name="sign" placeholder="" disabled>
				<template #title>
			...
			<van-cell center :value="addForm.a" name="worksign" placeholder="" disabled>
				<template #title>
			...
			<van-cell v-for="(item,index) in personBuildData" :key="index" center name="item.userId" placeholder="" disabled>
				<template #title>
			...
			<van-field v-if="addForm.checkpid!=null" style="margin-top: 10px;" v-model="addForm.checkMan" center disabled label="审核领导"></van-field>
			<van-field v-else style="margin: 10px 0;" v-model="addForm.checkMan" center disabled label="审核领导(审核中)"></van-field>
			<van-field v-show="addForm.checkpid!=null" v-model="addForm.checktime" center disabled label="审核时间"></van-field>
			<van-field v-show="addForm.checkpid!=null" v-model="addForm.remarks" center disabled label="审核意见"></van-field>

			<van-cell v-show="addForm.checkpid!=null" style="margin-bottom: 10px;" center :value="addForm.b" name="worksign"
			...
			<van-field v-show="addForm.safepid!=null" @click="gotodanger" v-model="addForm.safechecknav" center disabled label="安全检测详情"
			 is-link>
				<template #input>
					<span style="float: right;width: 100%;color: #409EFF;">已完成</span>
				</template>
			</van-field>
			<van-field v-show="addForm.safepid!=null" @click="gotogus" v-model="addForm.guscontinue" center disabled label="气体监测"
			 is-link>
				<template #input>
					<span style="float: right;width: 100%;color: #409EFF;">查看详情</span>
				</template>
			</van-field>
			<van-field v-model="addForm.safemanremarks" @input="showremarks" class="fieldmargin" name="losscontent" label="安全员审核意见"
			 placeholder="请输入安全员审核意见" type="textarea" autosize disabled></van-field>
			...
			<van-field v-show="addForm.safetyPatrolName!=''" v-model="addForm.safetyPatrolName" center disabled label="安巡员"></van-field>
			
			<div v-show="addForm.guarderBeforeSid!=null">
			...
			<van-cell v-show="addForm.safetyPatrolSpid!=null" style="margin: 10px 0;" center :value="addForm.a" name="worksign" placeholder="" disabled>
				<template #title>
			...
			<div v-show="addForm.guarderaftereSid!=null">
		...
		data() {
			return {
				addForm: {
					...
					applyeraddress: '',
					//安巡员
					safetyPatrolSpid: null,
					safetyPatrolSsign: '',
					safetyPatrolSsigntime: '',
					safetyPatrolSaddress: '',
					//作业后
					guarderaftereSid: null,
					guardersignafter: '',
			...
			getdetail(data) {
				...
				this.gettaskDetail(json).then(res => {
						if (res.data.code === 0) {
							...
							if (data.dataResponse.saferEducateSid != null) {
								...
								this.addForm.signaddress = ''
							}

							if (data.dataResponse.cmSid != null) {
								...
								this.addForm.worksign = ''
								this.addForm.worksigntime = ''
								this.addForm.worksignaddress = ''
							}

							if (data.dataResponse.approveSid != null) {
								...
								this.addForm.checksign = ''
								this.addForm.checksigntime = ''
								this.addForm.checksignaddress = ''
							}
							...
							this.addForm.checktime = data.dataResponse.approveSid != null ? this.formatDate(data.dataResponse.approveSid.createTime) :
								''
							this.addForm.checkpid = data.dataResponse.approveSid

							this.addForm.safepid = data.dataResponse.saferLiveConfirmSid
							...
							this.addForm.safetyPatrolName = data.dataResponse.safetyPatrolName
							//作业前
							this.addForm.guarderBeforeSid = data.dataResponse.guarderBeforeSid
							if (data.dataResponse.guarderBeforeSid != null) {
								...
								this.addForm.guardersign = ''
								this.addForm.guardersigntime = ''
								this.addForm.guarderaddress = ''
							}

							if (data.dataResponse.constructionBeforeSid != null) {
								...
								this.addForm.constructionsigon = ''
								this.addForm.constructionsigontime = ''
								this.addForm.constructionaddress = ''
							}

							if (data.dataResponse.saferBeforeSid != null) {
								...
								this.addForm.safersign = ''
								this.addForm.safersigntime = ''
								this.addForm.saferaddress = ''
							}

							if (data.dataResponse.applyerBofreSid != null) {
								...
								this.addForm.applyersign = ''
								this.addForm.applyersigntime = ''
								this.addForm.applyeraddress = ''
							}

							//安巡员
							this.addForm.safetyPatrolSpid = data.dataResponse.safetyPatrolSpid
							if (data.dataResponse.safetyPatrolSpid != null) {
								...
								this.addForm.safetyPatrolSsign = ''
								this.addForm.safetyPatrolSsigntime = ''
								this.addForm.safetyPatrolSaddress = ''
							}

							//作业后
							this.addForm.guarderaftereSid = data.dataResponse.guarderAfterSpid
							if (data.dataResponse.guarderAfterSpid != null) {
								...
								this.addForm.guardersignafter = ''
								this.addForm.guardersigntimeafter = ''
								this.addForm.guarderaddressafter = ''
							}

							if (data.dataResponse.constructionAfterSpid != null) {
								...
								this.addForm.constructionsigonafter = ''
								this.addForm.constructionsigontimeafter = ''
								this.addForm.constructionaddressafter = ''
							}

							if (data.dataResponse.saferAfterSpid != null) {
								...
								this.addForm.safersignafter = ''
								this.addForm.safersigntimeafter = ''
								this.addForm.saferaddressafter = ''
							}

							if (data.dataResponse.applyerAfterSpid != null) {
								...
								this.addForm.applyersignafter = ''
								this.addForm.applyersigntimeafter = ''
								this.addForm.applyeraddressafter = ''
							}
