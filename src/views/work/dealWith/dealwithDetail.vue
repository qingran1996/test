<template>
	<div class="dealwithDetail">
		...
		<van-form ref="outform">
			<van-field v-model="putform.person" name="person" label="入库人" placeholder="" disabled></van-field>
			<van-field v-model="putform.time" name="time" label="入库时间" placeholder="" disabled></van-field>
		</van-form>
		<!--下拉选择1234-->
