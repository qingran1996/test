  ...
  mounted() {
    ...
    window.onload = function() {
      ...
      Star.prototype.draw = function() {
        var x = Math.cos(this.timePassed) * this.orbitRadius + this.orbitX
        var y = Math.tan(this.timePassed) * this.orbitRadius + this.orbitY
